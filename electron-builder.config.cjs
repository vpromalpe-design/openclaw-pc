...
module.exports = {
  appId: 'com.openclaw.pc',
  productName: 'OpenClaw PC',
  copyright: 'Copyright © 2026 wurongzhao@AgentKernel',

  publish: {
    provider: 'github',
    owner: 'vpromalpe-design',
    repo: 'openclaw-pc',
  ...
  win: {
    ...
    icon: iconIcoPath,
    artifactName: 'OpenClaw-PC-Setup-${version}.${ext}',
  ...
  nsis: {
    ...
    installerLanguages: ['en_US', 'ru_RU', 'zh_CN'],
